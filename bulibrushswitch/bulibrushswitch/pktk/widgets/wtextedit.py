...
# -----------------------------------------------------------------------------
# The wtxtedit module provides basic rich text editor with formatting tool in
# toolbar
#
...
# - WTextEditDialog:
#       Widget
#       A basic dialog box providing access to text editor
#
# - WSmallTextEdit:
#       Widget
#       A small widget that give access to dialog box editor
#
# -----------------------------------------------------------------------------
...
class WTextEditDialog(QDialog):
    ...
    def edit(title, text, textColor=None, textBackgroundColor=None, toolbarBtns=None):
        ...
        if textBackgroundColor is not None:
...
class WTextEdit(QWidget):
    ...
    def __initToolBar(self):
        ...
        [Copy] [Cut] [Paste] | [Fnt name] [Fnt size] [Bold] [Ital.] [Underl.] [Strikethrough] [Fg Col.] [Bg Col.] | [Left align.] [Center align.] [Right align.] [Justified align.]
    ...
    def setToolbarButtons(self, value, mode=None):
        ...
        if mode not in (WTextEditBtBarOption.MODE_SET, WTextEditBtBarOption.MODE_ADD, WTextEditBtBarOption.MODE_REMOVE):
